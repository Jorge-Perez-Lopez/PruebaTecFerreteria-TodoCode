...
public class ProductoWebController {
    ...
    public ProductoWebController(ProductoService prodServ) {
    ...
    public String traerProductos(Model model) {
        model.addAttribute(
                "productos", prodServ.traerProductos()
        );
    ...
    public String crearProducto(@ModelAttribute Producto producto, Model model) {
        ...
        if (resultado == null) {
            ...
            model.addAttribute("error", "Revisa los datos. Nombre, marca y categoría son obligatorios. \" +\n" +
